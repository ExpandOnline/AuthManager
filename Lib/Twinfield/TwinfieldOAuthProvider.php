...
App::uses('TwinfieldResourceOwner','AuthManager.Lib/Twinfield');
 ...
 */
class TwinfieldOAuthProvider extends AbstractProvider
{
	...
	{
		return new TwinfieldResourceOwner($response);
	}
}